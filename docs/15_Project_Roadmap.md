...
- Per-job **screening questionnaire** (12 question types; mandatory/preferred/informational classification; rules private, sanitized public projection) ✅ spec'd ✅ built (5.1)
