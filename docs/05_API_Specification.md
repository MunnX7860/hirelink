...
| `POST /api/jobs/:id/screening-recompute` | Re-run the deterministic engine for the job's non-terminal applications (17 §4.4; chunked by the §9 worker) → 202 `{ queued: n }`                                                                                                                                                       |
