...
| `GET /api/ai/screenings/:id`             | Session detail + `results` (streamed incrementally while `processing` — progress view shows partial groups; grouped by category, ordered rank; per-row `reasons/evidence/uncertainties`)                                                                                                                                                                                                   |
